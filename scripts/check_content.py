...
SUBMODULES = ['02-1-data-and-payload-shape.md', '02-2-variables-and-jsonpath.md', '03-1-choosing-the-right-trigger.md', '03-2-filters-and-specialized-triggers.md', '05-1-action-contracts-and-core-actions.md', '05-2-error-handling-external-actions-and-success-boundaries.md', '08-1-operating-a-workflow.md', '08-2-limits-change-and-governance.md', '09-1-capability-ownership.md', '09-2-architecture-decisions-and-tradeoffs.md', '10-1-pattern-method-and-core-patterns.md', '10-2-working-engineer-patterns.md', '10-3-advanced-patterns-and-pattern-transfer.md', '11-1-repetition-partial-failure-and-concurrency.md', '11-2-scale-correlation-and-external-state.md', '12-1-paper-design-framework.md', '12-2-capstone-design-lab.md', '04-1-decisions-guards-and-variables.md', '04-2-loops-and-repeated-logic.md', '06-1-forms-input-and-human-delay.md', '06-2-approvals-and-interactive-processes.md', '07-1-safe-testing-and-first-divergence.md', '07-2-boundary-diagnosis-and-retesting.md']
